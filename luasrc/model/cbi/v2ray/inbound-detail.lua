...
o = s:option(Value, "s_trojan_email", "%s - %s" % { "Trojan", translate("Email") })
o:depends("protocol", "trojan")

o = s:option(Value, "s_trojan_level", "%s - %s" % { "Trojan", translate("User level") })
o:depends("protocol", "trojan")
o.datatype = "uinteger"
...
o = s:option(Value, "s_wireguard_address", "%s - %s" % { "WireGuard", translate("Address") },
	translate("WireGuard interface address, e.g., 10.0.0.1/24"))
o:depends("protocol", "wireguard")
o.datatype = "cidr"

o = s:option(Value, "s_wireguard_listen_port", "%s - %s" % { "WireGuard", translate("Listen port") })
o:depends("protocol", "wireguard")
o.datatype = "port"
...
o = s:option(DynamicList, "s_wireguard_peer_public_key", "%s - %s" % { "WireGuard", translate("Peer public key") })
o:depends("protocol", "wireguard")

o = s:option(DynamicList, "s_wireguard_peer_allowed_ips", "%s - %s" % { "WireGuard", translate("Peer allowed IPs") })
o:depends("protocol", "wireguard")
o.placeholder = "0.0.0.0/0"

o = s:option(DynamicList, "s_wireguard_peer_endpoint", "%s - %s" % { "WireGuard", translate("Peer endpoint") })
o:depends("protocol", "wireguard")
o.placeholder = "example.com:51820"

o = s:option(Value, "s_wireguard_persistent_keepalive", "%s - %s" % { "WireGuard", translate("Persistent keepalive") })
o:depends("protocol", "wireguard")
o.datatype = "uinteger"
o.placeholder = "25"
