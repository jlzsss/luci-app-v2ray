...
-- Settings Blackhole
o = s:option(ListValue, "s_blackhole_response_type", "%s - %s" % { "Blackhole", translate("Response type") } )
...
o = s:option(ListValue, "s_vless_user_security", "%s - %s" % { "VLESS", translate("Security") })
o:depends("protocol", "vless")
o:value("")
o:value("auto", translate("Auto"))
o:value("none", translate("None"))
...
o = s:option(Value, "s_wireguard_address", "%s - %s" % { "WireGuard", translate("Address") },
	translate("WireGuard interface address, e.g., 10.0.0.2/24"))
o:depends("protocol", "wireguard")
o.datatype = "cidr"
...
o = s:option(Value, "s_wireguard_peer_endpoint", "%s - %s" % { "WireGuard", translate("Peer endpoint") })
o:depends("protocol", "wireguard")
o.placeholder = "example.com:51820"

o = s:option(DynamicList, "s_wireguard_allowed_ips", "%s - %s" % { "WireGuard", translate("Allowed IPs") })
o:depends("protocol", "wireguard")
